    ...
    function printDiv(imprimir) {
      ...
      <div class="tab-pane fade in active"  id="pagos">
        <div class="modalfade">
          <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 col-xl-8 col-lg-offset-2 col-md-offset-2 col-sm-offset-2 col-xl-offset-2">
            <div class="panel animated fadeInDown">
              <div class="modal-header">
                ...
                <div class="row justify-content-md-center">
                  ...
                  col-md-offset-2 col-sm-offset-2 col-xs-offset-1">
